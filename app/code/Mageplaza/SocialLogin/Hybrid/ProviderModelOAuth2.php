...
/**
 * To implement an OAuth 2 based service provider, ProviderModelOAuth2
 * can be used to save the hassle of the authentication flow.
 *
 * Each class that inherit from ProviderModelOAuth2 have to implement
 * at least 2 methods:
 ...
 *
 * ProviderModelOAuth2 use OAuth2Client v0.1 which can be found on
 * Hybrid/thirdparty/OAuth/OAuth2Client.php
 */
class ProviderModelOAuth2 extends ProviderModel {
